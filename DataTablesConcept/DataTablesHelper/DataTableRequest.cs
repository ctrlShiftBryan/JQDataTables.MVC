...
namespace DataTablesHelper
{
    ...
    {
        public DataTableRequest(T col, int? limit = null, string schema = "dbo") : base(col, limit)
        {
            SetDefaults(schema);
        }

        public DataTableRequest() : base(new T(), null)
        {
            SetDefaults("dbo");
        }
        ...
        public string SelectStatement
        {
            ...
            get
            {
                return String.Format(GetSQLTemplate
                    ...
                    , this.GetWhereClause()//3 AND WHERE CLAUSE
